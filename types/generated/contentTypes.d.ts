...
export interface ApiIndividualSessionIndividualSession
  extends Struct.CollectionTypeSchema {
  collectionName: 'individual_sessions';
  info: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::individual-session.individual-session'
    > &
      Schema.Attribute.Private;
  };
}
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isActiveReview: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
...
export interface ApiTypePriceTypePrice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    translate: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 1;
        maxLength: 255;
